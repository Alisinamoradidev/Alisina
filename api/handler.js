        ...
        <tr><td style="padding:24px 40px;border-top:1px solid #e2e8f0;text-align:center;color:#94a3b8;font-size:13px">
          ...
          if (gmailUser && gmailPass) {
            ...
            if (toEmail) {
              ...
              tasks.push(t.sendMail({ from: `"Alisina Realty" <${gmailUser}>`, to: toEmail, subject: `New payment received — ${propName}`,
            ...
            if (customerEmail) {
              const t = nodemailer.createTransport({ host: 'smtp.gmail.com', port: 587, secure: false, auth: { user: gmailUser, pass: gmailPass } });
              tasks.push(t.sendMail({ from: `"Alisina Realty" <${gmailUser}>`, to: customerEmail, subject: `Payment Confirmed — ${propName}`,
